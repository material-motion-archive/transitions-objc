 ...
 */
struct NS_SWIFT_NAME(TransitionWindowSegment) MDMTransitionWindowSegment {
...
NS_SWIFT_NAME(TransitionWindowSegmentEpsilon)
extern const CGFloat MDMTransitionWindowSegmentEpsilon;

/** Returns a new segment with an inverted position. */
FOUNDATION_EXPORT struct MDMTransitionWindowSegment MDMTransitionWindowSegmentInverted(struct MDMTransitionWindowSegment segment)
    NS_SWIFT_NAME(TransitionWindowSegmentInverted(segment:));
